...
import type { DashboardData } from '../../lib/types.repo'
  ...
  async function create() {
    ...
    try {
      ...
      if (docs.length === 0 || !hasRepo) {
        throw new Error('insufficient data for REPO')
      }
          ...
          <div className="space-y-4">
              ...
              <Card className="max-w-md space-y-2">
                {creating ? (
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm">Running REPO analysis…</span>
                  </div>
                ) : (
                  <>
                    <button
            ...
            {data && (
              <button
                ...
                className="px-4 py-2 bg-emerald-600 text-sm font-medium rounded-lg hover:bg-emerald-500 transition"
              >
                {creating ? 'Recreating…' : 'Recreate REPO'}
              </button>
            )}
          ...
          <div className="text-right leading-tight">
            ...
            {!creating && (
              <div className="relative mt-8 ml-auto w-80 h-60">
                ...
                <div className="absolute left-1/2 top-1/2 w-16 h-16 -translate-x-1/2 -translate-y-1/2 rounded-full border-2 border-emerald-500 bg-emerald-500/10 flex items-center justify-center text-sm font-medium">REPO</div>
                <Link
                  href="/ingest"
